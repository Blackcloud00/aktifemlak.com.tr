                ...
                <form action="">
                    ...
                    <div class="form-group d-flex flex-column">
                        ...
                        <div class="check-group">
                            ...
                            <label><input type="radio" name="isitma" value="Soba" /><span class="custom-radio"></span> Soba</label>
                    ...
                    <div class="form-group d-flex flex-column button-group">
                        <input type="button" class="button" value="Arama Yap" />
                    </div>
                </form>
            </div>
