<section class="category_list">
    <div class="container">
        <div class="row justify-content-between align-items-center cate_text">
            ...
            <div class="col-lg-7 d-flex justify-content-lg-end justify-content-start mt-lg-0 mt-4 special_buttons">
                ...
                <a style="cursor:pointer;" class="cat_button grid_button grd_button">
                ...
                <a style="cursor:pointer;" class="cat_button grid_button brd_button">
            ...
            <div class="col-12 filter_area_btn justify-content-end">
